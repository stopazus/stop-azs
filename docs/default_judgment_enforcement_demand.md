...
**In the {{COURT_NAME}}**
**{{PLAINTIFF_LEGAL_NAME}},** a {{PLAINTIFF_STATE}} {{PLAINTIFF_ENTITY_TYPE}},
Plaintiff,
...
Plaintiff {{PLAINTIFF_LEGAL_NAME}} ("Plaintiff"), by and through undersigned counsel, respectfully moves this Court, pursuant to {{APPLICABLE_RULE_OR_STATUTE}}, for the entry of a default judgment against Defendants {{DEFENDANT_1_NAME}}, {{DEFENDANT_2_NAME}}, {{DEFENDANT_3_NAME}}, and {{DEFENDANT_4_NAME}} (collectively, "Defendants"). In support, Plaintiff states as follows:
...
"""Plaintiff certifies that a copy of this Motion has been served upon all parties against whom a default judgment is sought in accordance with {{SERVICE_RULE_CITATION}}. Plaintiff respectfully requests that the Court set this Motion for hearing at the earliest opportunity, or in the alternative, enter the requested relief based on the written record and supporting affidavits filed contemporaneously herewith."""

Respectfully submitted,

________________________________________
{{ATTORNEY_NAME}}, Esq.
{{BAR_NUMBER_AND_JURISDICTION}}
Counsel for Plaintiff {{PLAINTIFF_LEGAL_NAME}}
{{LAW_FIRM_NAME}}
{{LAW_FIRM_ADDRESS}}
{{LAW_FIRM_PHONE}} | {{LAW_FIRM_EMAIL}}

Date: __________________

> **Template usage guidance:** Replace each placeholder wrapped in double curly braces (e.g., `{{PLAINTIFF_LEGAL_NAME}}`) with the corresponding case-specific information. Do **not** insert real personal identifiers, account numbers, or other sensitive data unless the document is being finalized for a specific, authorized legal filing.
