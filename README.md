...
- Reconnects NAS-hosted cloud mirrors to standard drive letters (G:, I:, O:) documented in
  [docs/nas_drive_mapping.md](docs/nas_drive_mapping.md) — currently `\\192.168.50.200` shares for Google,
  iCloud, and OneDrive — so investigators can restore shortcuts after reinstalls.
