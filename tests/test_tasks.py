...
def test_restore_supports_paths_with_hyphens(tmp_path: Path) -> None:
    """Ensure restoration works for destinations containing hyphens."""

    from sar_parser.tasks import DEFAULT_TASKS, restore_onedrive_tasks

    destination = tmp_path / "Volumes" / "SSD-PRO" / "appdata" / "onedrive_tasks.json"
